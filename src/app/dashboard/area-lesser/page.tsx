...
import { AreaLesserTable } from '@/components/applications/area-lesser-table';
import { getApplicationsByArea, getApplicationStatuses } from '@/app/actions';
import { cookies } from 'next/headers';
import { redirect } from 'next/navigation';
import { ServerLogHandler } from '@/components/debug/server-log-handler';

export default async function AreaLesserPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
  ...
  const [
    ...
    getApplicationsByArea(accessToken, 'lesser'),
