...
import { SdoHillReportTable } from '@/components/applications/sdo-hill-report-table';
...
export default async function SdoHillReportPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
    ...
    <>
      ...
      <div className="flex-1 space-y-4 px-4 md:px-8">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight font-headline">SDO Change of land use</h1>
        </div>
        <SdoHillReportTable
