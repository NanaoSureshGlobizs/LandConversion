...
import { LrdHillReportTable } from '@/components/applications/lrd-hill-report-table';
...
export default async function LrdHillReportPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
