...
const getInitialValues = (
  ...
  return {
    ...
    aadhaar_consent: !!application.aadhar_no,
...
const steps = [
  ...
  { id: 'Step 3', name: 'Applicant & Plot Info', fields: ['name', 'date_of_birth', 'aadhaar_consent', 'aadhar_no', 'address', 'phone_number', 'email', 'patta_no', 'dag_no', 'location_type_id', 'original_area_of_plot', 'area_unit_id', 'area_applied_for_conversion', 'application_area_unit_id', 'land_classification_id', 'purpose_id', 'other_entry', 'land_address'] },
