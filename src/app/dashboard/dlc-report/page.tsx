...
import { DlcReportTable } from '@/components/applications/dlc-report-table';
...
export default async function DlcReportPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
    ...
    <>
      ...
      <div className="flex-1 space-y-4 px-4 md:px-8">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight font-headline">DLC Report ({type === 'conversion' ? 'Conversion' : 'Diversion'})</h1>
        </div>
        <DlcReportTable
