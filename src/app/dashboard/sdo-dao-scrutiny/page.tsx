...
import { SdoDaoScrutinyTable } from '@/components/applications/sdo-dao-scrutiny-table';
    ...
    <>
      ...
      <div className="flex-1 space-y-4 px-4 md:px-8">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight font-headline">SDO/DAO (Scrutiny)</h1>
        </div>
        <SdoDaoScrutinyTable 
