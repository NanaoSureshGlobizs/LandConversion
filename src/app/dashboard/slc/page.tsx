...
import { SlcTable } from '@/components/applications/slc-table';
...
export default async function SlcPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
    ...
    <>
      ...
      <div className="flex-1 space-y-4 px-4 md:px-8">
        <div className="flex items-center justify-between space-y-2">
          <h1 className="text-3xl font-bold tracking-tight font-headline">SLC List</h1>
        </div>
        <p className="text-muted-foreground">
          View and process applications at the SLC level.
        </p>
        <SlcTable
